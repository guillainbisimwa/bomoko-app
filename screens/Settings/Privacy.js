  ...
  return (
    ...
    >
      ...
      <Text style={styles.footer}>
        En utilisant l'application Afrintech, vous acceptez les termes de cette Politique de Confidentialité.
      </Text>
