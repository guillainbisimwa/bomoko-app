  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Bienvenue dans la section d'aide et de support de l'application Afrintech. Nous sommes là pour vous aider à résoudre tout problème que vous pourriez rencontrer lors de l'utilisation de notre application.
      </Text>
      ...
      <Text style={styles.paragraph}>
        Visitez notre centre d'aide en ligne pour accéder à des guides détaillés, des tutoriels et des ressources pour vous aider à tirer le meilleur parti de l'application Afrintech.
      </Text>
