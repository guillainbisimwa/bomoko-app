  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        En utilisant l'application mobile Afrintech ("l'Application"), vous acceptez de respecter les conditions d'utilisation énoncées ci-dessous. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser l'Application.
      </Text>
      ...
      <Text style={styles.paragraph}>
        Tous les droits de propriété intellectuelle relatifs à l'Application sont la propriété de Afrintech. Vous n'êtes pas autorisé à copier, modifier, distribuer ou reproduire l'Application sans autorisation expresse.
      </Text>
